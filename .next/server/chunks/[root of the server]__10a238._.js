...
"[project]/src/service/AuthService.ts [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const login = async (email, password)=>{
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].usuario.findUnique({
        where: {
            email
        }
    });
    if (!user) throw new Error("Credenciales inválidas");
    const passwordMatch = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcryptjs__$5b$external$5d$__$28$bcryptjs$2c$__cjs$29$__["default"].compare(password, user.password);
...
const loginWithToken = async (token)=>{
    try {
        const decoded = __TURBOPACK__imported__module__$5b$externals$5d2f$jsonwebtoken__$5b$external$5d$__$28$jsonwebtoken$2c$__cjs$29$__["default"].verify(token, JWT_SECRET);
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].usuario.findUnique({
            where: {
                cod_usuario: decoded.userId
            }
        });
        return {
            token,
...
"[project]/src/controller/AuthController.ts [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$service$2f$AuthService$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/service/AuthService.ts [api] (ecmascript)");
;
const loginUser = async (req, res)=>{
    ...
    try {
        let result;
        if (token) {
            result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$service$2f$AuthService$2e$ts__$5b$api$5d$__$28$ecmascript$29$__.loginWithToken(token);
        } else if (email && password) {
            result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$service$2f$AuthService$2e$ts__$5b$api$5d$__$28$ecmascript$29$__.login(email, password);
        } else {
            return res.status(400).json({
                error: "Por favor proporciona el email y la contraseña o un token"
            });
        }
...
"[project]/src/pages/api/ApiLogin.ts [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$controller$2f$AuthController$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/controller/AuthController.ts [api] (ecmascript)");
...
async function handler(req, res) {
    ...
    switch(method){
        case "POST":
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$controller$2f$AuthController$2e$ts__$5b$api$5d$__$28$ecmascript$29$__.loginUser(req, res);
        default:
...
"[project]/node_modules/next/dist/esm/build/templates/pages-api.js { INNER_PAGE => \"[project]/src/pages/api/ApiLogin.ts [api] (ecmascript)\" } [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$ApiLogin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/pages/api/ApiLogin.ts [api] (ecmascript)");
;
;
;
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$helpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["hoist"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$ApiLogin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__, 'default');
const config = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$helpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["hoist"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$ApiLogin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__, 'config');
const routeModule = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$modules$2f$pages$2d$api$2f$module$2e$compiled$2e$js__$5b$api$5d$__$28$ecmascript$29$__["PagesAPIRouteModule"]({
    definition: {
        kind: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$kind$2e$js__$5b$api$5d$__$28$ecmascript$29$__["RouteKind"].PAGES_API,
        page: "/api/ApiLogin",
        pathname: "/api/ApiLogin",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$ApiLogin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__
}); //# sourceMappingURL=pages-api.js.map
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__10a238._.js.map