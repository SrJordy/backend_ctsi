...
const loginUser = async (req, res)=>{
    ...
    try {
        let generatedToken;
        if (token) {
            generatedToken = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$service$2f$AuthService$2e$ts__$5b$api$5d$__$28$ecmascript$29$__.loginWithToken(token);
        } else if (email && password) {
            generatedToken = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$service$2f$AuthService$2e$ts__$5b$api$5d$__$28$ecmascript$29$__.login(email, password);
        } else {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1d8e3e._.js.map